...
public class EjemplosUso {
    ...
    public void ejemplo2_ObtenerProductos() {
        List<Map<String, Object>> productos = ProductoDAO.obtenerProductos();
    ...
    public void ejemplo4_PrecioMinimo() {
        ...
        Double precioMin = ProductoService
    ...
    public void ejemplo5_FuenteBarata() {
        ...
        Map<String, Object> fuente = 
            ProductoService.obtenerFuenteBarata(productos, "Lechuga");
